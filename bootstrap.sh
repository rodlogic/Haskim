...
curl https://raw.github.com/rodlogic/Haskim/master/.vimrc.local -L -o - >> ${PREFIX}/.haskim.vimrc.local
...
curl https://raw.github.com/rodlogic/Haskim/master/.vimrc.bundles.local -L -o - >> ${PREFIX}/.haskim.vimrc.bundles.local
